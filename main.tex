...
「小型移動ロボットにおける屋外で安全に自律移動するためのシステムの構築」を目的として、
...
今までは、ROSを使用していたが、ROSの最終リリースであるROS Noetic Ninjemysが2025年5月に
...
ツナチームとたまチームは、外界センサとして2次元LiDAR、むぎまるチームは、3次元LiDARを搭載した。

たまチームは、外界センサとして2次元LiDAR、内界センサとしてIMU
むぎまるチームは、外界センサとして3次元
